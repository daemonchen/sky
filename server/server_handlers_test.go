...
func TestServerStats(t *testing.T) {
	runTestServer(func(s *Server) {
		...
		assertResponse(t, resp, 200, `[{"entries":0,"size":2199023255552,"depth":0,"transactions":{"last":0},"readers":{"max":126,"current":0},"pages":{"last":1,"size":4096,"branch":0,"leaf":0,"overflow":0}},{"entries":0,"size":2199023255552,"depth":0,"transactions":{"last":0},"readers":{"max":126,"current":0},"pages":{"last":1,"size":4096,"branch":0,"leaf":0,"overflow":0}}]`+"\n", "GET /stats failed.")
	})
}
